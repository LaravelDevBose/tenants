...
@section('content')
            ...
            <div class="col-md-8 ">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('expenses.update', $expense->id) }}" name="expenses_insert" method="POST">{{ csrf_field() }}
                            {{ csrf_field()}}
                            {{ method_field('PUT')}}
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Title:</label>
                                    <input type="text" name="title" value="{{ $expense->title }}" maxlength="80" class="form-control" placeholder="Enter Your Expense Title">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="date" value="{{ $expense->date }}" class="form-control datepicker" placeholder="Pick a date&hellip;">
                                    </div>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Amount:</label>
                                    <input type="number" name="amount" value="{{ $expense->amount }}" class="form-control" placeholder="Expense Amount">
                                </div>
                                <div class="form-group col-md-6">
                ...
                <div class="panel ">
                    ...
                    <div class="modal-body">
                        <div class="row" id="expense_type_insert">
                            ...
                            <button type="button" class="btn btn-success btn-sm pull-right" id="insert_edit">Save</button>
                        </div>
                    </div>
    ...
    <script>
        document.forms['expenses_insert'].elements['expenses_type'].value={{ $expense->expenses_type }}
            document.forms['expenses_insert'].elements['payment_type'].value={{ $expense->payment_type }}
            document.forms['expenses_insert'].elements['status'].value={{ $expense->status }}
